...
// 	createprintchannel( "script_autodifficulty" );
	...
	level.difficultySettings[ "flashbangedInvulFactor" ][ "veteran" ]  = 0;
		...
		level.difficultySettings[ "coopPplayer_deathInvulnerableTime" ][ "hardened" ][2] 	= 0.8;
		...
		level.difficultySettings[ "coopPlayerDifficultyHealth" ][ "easy" ][3] = 0.85; 
...
{
	if (isdefined(level.nr_active)) return false;
