...
init()
{
    ...
    add("pack", "PACK-A-PUNCH", 5000, (560, 845, 160), 0, "zombie_vending_packapunch_on", (0.5,0.8,1));
    add("power", "RESTORE POWER", 0, (455, 845, 168), 0, "zombie_power_lever", (1,0.8,0.35));
    add("relay_a", "STARTING ROOM RELAY", 0, (200, -380, 48), 90, "zombie_power_lever", (1,0.8,0.35));
    add("relay_b", "HELP ROOM RELAY", 0, (1045, 855, 40), 270, "zombie_power_lever", (1,0.8,0.35));
